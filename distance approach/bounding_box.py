...
import imutils
import math
json_filename = "D:\Solethon\perception\keypoint\\test0_cones.json"
with open(json_filename) as f:
    json_data = json.load(f)


path ="D:\Solethon\perception\keypoint\\newcone\\test0.mp4"
...
while cap.isOpened():
    ...
    for j in range(len(detections)):
        ...
        if z.shape[0] != 0 and z.shape[1]!=0:
            ...
            ############################                realtiveDistance
            distance = int(math.sqrt(((detections[j][2][2]) - detections[j][2][1]) ** 2 + ((detections[j][2][3]) - detections[j][2][0]) ** 2))
...
# D:\Solethon\perception\keypoint\cone.py
# for wrapperception

# D:\Solethon\perception\keypoint\newcone1\newconev2\coneV3working.py
# for pnp working with good speed